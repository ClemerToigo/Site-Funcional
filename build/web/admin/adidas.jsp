...
<html lang="pt-br">
    ...
    <body style="background-color: #6b747c;">
        ...
        %>
        <div id="login">
            <h3 class="text-center text-white pt-5" style="padding-bottom: 10px">Cadastrar Marca Adidas</h3>
            <div class="container">
                <div id="login-row" class="row justify-content-center align-items-center" >
                    <div id="login-column" class="col-md-6" >
                        <div id="login-box" class="col-md-12" style="height: auto; margin-top: 0; border-radius: 10px; background-color:#27242e ;">
                            ...
                            <form action="config/cadastraAdidas.jsp" method="POST" enctype="multipart/form-data">
        ...
        <div class="container">
            <h2>Produtos Adidas Cadastrados</h2>
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editarAdidas.jsp?id=<%=rs.getString("id")%>" class="text-info" ><i class='fas fa-history' style='font-size:20px'></i></a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="adidas.jsp?funcao=excluir&id=<%=rs.getString(1)%>" class="btn btn-danger">Excluir</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <%
                if (request.getParameter("funcao") != null && request.getParameter("funcao").equals("excluir")) {
                    ...
                    try {
                        ...
                        con = DriverManager.getConnection(url, usuario, senhaBD);
                        st = con.createStatement();
                        st.executeUpdate("DELETE from adidas WHERE id = '" + id + "' ");
                        response.sendRedirect("adidas.jsp?status=3");//Registro deletado com sucesso
                    } catch (Exception e) {
                        out.println(e);
                    }
                }
