...
<html lang="pt-br">
    ...
    <body style="background-color: #6b747c;">
        ...
        %>
        <div id="login">
            <h3 class="text-center text-white pt-5" style="padding-bottom: 10px">Editar Marca Adidas</h3>
            <%
                ...
                try {
                    ...
                    rs = st.executeQuery("SELECT *FROM adidas WHERE id  = '" + id + "' ");
                    while (rs.next()) {%>
            <div class="container">
                <div id="login-row" class="row justify-content-center align-items-center" >
                    <div id="login-column" class="col-md-6" >
                        <div id="login-box" class="col-md-12" style="height: auto; margin-top: 0; border-radius: 10px; background-color:#27242e ;">
                            ...
                            <form action="config/editaAdidas.jsp?id=<%=rs.getString("id")%>" method="POST" enctype="multipart/form-data">
