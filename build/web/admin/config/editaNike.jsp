...
<%
    ...
    if(up.formProcess(getServletContext(),request)){
        ...
        try{
            ...
            st.executeUpdate("UPDATE nike set nome='"+nome+"',descricao='"+desc+"',valor='"+valor+"',imagem='"+imagem+"'  WHERE id='"+id+"' ");
            ...
            response.sendRedirect("../nike.jsp?status=2");//Adicionado com sucesso
        }catch(Exception e){
            out.print(e);
        }
