...
<%
  ...
  if(email == "" || senha == ""){//Verifica se possui campos em branco
    ...
    try{
        ...
        while(rs.next()){
           user = rs.getString(4);//Armazenando o email do banco
           pass = rs.getString(3);//Armazenando a senha do banco
    ...
    if(email.equals(user) && senha.equals(pass)){
        ...
        response.sendRedirect("../../pagina.jsp");//redireciona para pagina inicial do ADMIN
    }else{
